...
public class LinkedList : IEnumerable<int> {
    ...
    public void InsertTail(int value) {
        ...
        // If the list is not empty, then only tail will be affected.
            ...
            _tail = newNode; // Update the tail variable to point to the new node
        }
    }
    ...
    public void Remove(int value) {
        ...
        while (curr is not null) {
            if (curr.Data == value) {
                ...
                // then we can just remove the head
                if (curr == _head) {
                    RemoveHead();
                }
                // The same goes for the tail
                else if (curr == _tail) {
                    RemoveTail();
                }
                // For any other location of 'value', need to link the previous and following
                // node to each other
                else {
